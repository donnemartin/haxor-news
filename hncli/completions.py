...
META_OPTION_COMMENTS_HIDE_NON_MATCHING = 'Hide instead of collapse non-matching comments (flag)'
...
DISPLAY_LOOKUP = {
    ...
    OPTION_COMMENTS_HIDE_NON_MATCHING_SHORT: META_OPTION_COMMENTS_HIDE_NON_MATCHING,
